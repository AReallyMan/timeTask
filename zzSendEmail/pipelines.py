                    ...
                    for row in colldata.find():
                        ...
                        if self.judge_date_range(spider.start_time, spider.end_time, row['day']):
                            line = [row['title'], row['budget'], row['project'],
                                    ...
                                    row['openTime'], row['address'], row['url'],row['purchase_address']]
                            ws.append(line)
                            wb.save(exportfile)
                    print(exportfile, '已经成功执行caigoushunyiSpiderNew', 'caigoushunyiSpiderNew')
